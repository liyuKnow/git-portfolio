        ...
        <div className="intro">
            <div className="intro-left">
                <div className="intro-left-wrapper">
                    ...
                    <h1 className="intro-name">Kidus Taye</h1>
                    ...
                    <div className="intro-desc">
                        <p> I Develope, maintain and create awesome websites and website contents.
                            I am a passionate UI/UX designer and a photographer.
            ...
            <div className="intro-right">
                ...
                <img className="intro-img" src={Me} alt="kidus taye" />
            </div>
        </div>
    )
}
